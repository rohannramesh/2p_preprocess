...
filename = 'D:\User Folders\Andrew\Slicing Imaging Analysis\F1392\F1392_slice1_expt1\Processed Stacks\Raw Registered Stacks\F1392_slice1_expt1_chunk1_xyreg.tif';      % path to stack tiff file
...
%     data = matfile([filename(1:end-3),'mat'],'Writable',true);
    ...
    chunksize=500;                 % user input: read and map input in chunks (optional, default read all at once)
    data = memmap_file_AL(filename,sframe,num2read,chunksize);
