...
nam = 'D:\User Folders\Andrew\Slicing Imaging Analysis\F1392\F1392_slice1_expt1\Processed Stacks\Raw Registered Stacks\F1392_slice1_expt1_chunk1_xyreg.tif';          % insert path to tiff stack here
%sframe=1;						% user input: first frame to read (optional, default 1)
%num2read=250;					% user input: how many frames to read   (optional, default until the end)
%Y = bigread2(nam);
Y = readtiff(nam);
%Y = Y - min(Y(:)); 
...
merge_thr = 0.48;                                  % merging threshold
