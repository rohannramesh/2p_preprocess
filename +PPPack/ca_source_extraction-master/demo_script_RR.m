...
nam = 'S:\twophoton_data\2photon\scan\OA27\170211_OA27\170211_OA27_run2\tiff_folder\mov1.tif';          % insert path to tiff stack here
...
edges = [70 70 25 25];
Y = Y(edges(3):end-edges(4)-1,edges(1):end-edges(2)-1,:);
[d1,d2,T] = size(Y);                                % dimensions of dataset
d = d1*d2;                                          % total number of pixels
