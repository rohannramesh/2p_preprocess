function [outs,stack]=sbxStackRegister(stack,target,usFacs,shifts_xy,display_text_tag);
...
%
% Shifts_xy is a nframes x 4 vector identical to output of
...
for index = 1:nframes
   ...
   if isempty(shifts_xy)
       [outs(index,:) temp ] = PPPack.hf.dftregistration(TARGET,SLICE,usFacs);
   else
