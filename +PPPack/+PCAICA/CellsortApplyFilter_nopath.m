function cell_sig = CellsortApplyFilter(movtds, ica_segments, flims, movm, subtractmean)
...
while k<nt
    ...
    for j=1:ntcurr
%         movcurr = imread(fn,'tiff',j+k+flims(1)-1,'Info',info);
