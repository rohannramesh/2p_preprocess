function [ica_segments, segmentlabel, segcentroid] = CellsortSegmentation_axon(ica_filters, smwidth, thresh, arealims, plotting)
...
for j = 1:nic
    ...
    % Recombine to one axon - RR - centroid is that of largest piece and
